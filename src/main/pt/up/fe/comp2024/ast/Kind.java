...
public enum Kind {
    ...
    private static final Set<Kind> EXPRESSIONS = Set.of(ARRAY_ACESS, PROPERTY_ACESS, LENGTH_ACESS, METHOD_CALL, BOOLEAN_VALUE, THIS, VAR_REF_EXPR, INTEGER_LITERAL, PARENTHESES_EXPRESSION, BINARY_EXPR, RELATIONAL_EXPRESSION, LOGICAL_EXPRESSION, NOT_EXPRESSION, NEW_ARRAY, ARRAY_INIT, NEW_CLASS_INSTANCE);
